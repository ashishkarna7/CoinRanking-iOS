...
class RankListViewModel: BaseListViewModel {
    ...
    private(set) var manager: RankManagerProtocol
    ...
    init(manager: RankManagerProtocol, type: FilterType) {
    ...
    override func getItemList(type: ContentLoadingType) {
        ...
        handleCompletion(manager.executeRankList(page: self.currentPageOffset, filterType: filterType))
    }
    ...
    func getItem(from indexPath: IndexPath) -> RankListItemViewModel {
